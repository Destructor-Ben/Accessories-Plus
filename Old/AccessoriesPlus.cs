/* TODO - only being kept so I don't have to rewrtie the wing and hook stats
...
void ModifyBalloons()
{
    CustomAccessories.Add(ItemID.BundleofBalloons, new APCustomAccessory(
        // Changing defaults
        (item) => item.SetNameOverride("Bundle of Horseshoe Balloons"),
